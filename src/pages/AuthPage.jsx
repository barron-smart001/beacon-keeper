    ...
    <main className="grid min-h-screen bg-[var(--bg)] lg:grid-cols-[1.05fr_0.95fr]">
      <section className="relative hidden overflow-hidden border-r border-[var(--border-soft)] bg-[var(--surface)] p-10 lg:flex lg:flex-col">
        ...
        <div className="relative z-10 my-auto max-w-lg">
          <p className="text-xs font-semibold uppercase tracking-[0.18em] text-[var(--accent)]">
            A more intentional practice
          </p>

          <h1 className="mt-5 text-5xl font-medium tracking-[-0.055em]">
            The record behind your progress.
          </h1>
          ...
          <div className="mt-10 rounded-2xl border border-[var(--border)] bg-[#0d0e12] p-5">
            ...
            <div className="mt-5 space-y-3">
              {[
                ...
                "Review your decisions honestly",
              ].map((item) => (
                <div
                  key={item}
      ...
      <section className="flex min-h-screen items-center px-5 py-10 sm:px-8 lg:px-16">
        <div className="mx-auto w-full max-w-md">
          ...
          <h2 className="mt-5 text-3xl font-medium tracking-[-0.045em] sm:text-4xl">
            {title}
          </h2>
          ...
          <form className="mt-8" noValidate onSubmit={handleSubmit}>
              ...
              <>
                ...
                {!isSignUp && (
                  <div className="mt-3 flex justify-end">
                    <Link
                      to="/forgot-password"
                      className="text-sm font-medium text-[var(--accent-light)] transition hover:text-[var(--accent)]"
                    >
                      Forgot password?
                    </Link>
                  </div>
            ...
            {isSignUp && (
              <label className="mt-5 flex gap-3 text-xs leading-5 text-[var(--text-secondary)]">
                <input
                  type="checkbox"
                  required
                ...
                I agree to receive important account and product updates.
              </label>
            )}
          ...
          {isForgotPassword ? (
            <p className="mt-7 text-center text-sm text-[var(--text-secondary)]">
              ...
              <Link
                to="/sign-in"
                className="font-semibold text-[var(--accent-light)] hover:text-[var(--accent)]"
              >
                Sign in
              </Link>
            </p>
